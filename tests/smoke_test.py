#!/usr/bin/env python3
"""
Quick smoke test for PromptVault functionality
"""
import tempfile
import shutil
...
def test_cli_operations():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            assert Path("promptvault.yaml").exists(), "Config file not created"
...
def main():
    """Run all smoke tests"""
    print("🚀 Running PromptVault smoke tests...\n")
    ...
    try:
        ...
        print("\n🎉 All smoke tests passed! PromptVault is working correctly.")
        return 0

#!/usr/bin/env python3
"""
Test runner for PromptVault with different test categories
"""
import sys
import subprocess
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Run PromptVault tests")
    parser.add_argument(
        "test_type",
        nargs="?",
        default="all",
